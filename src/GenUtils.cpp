...
std::vector<double>  GenUtils::NaturalBreaks(int num_cats, vector<double>& data, vector<bool>& undef)
{
...
std::vector<double>  GenUtils::QuantileBreaks(int num_cats, vector<double>& data, vector<bool>& undef) {
...
std::vector<double>  GenUtils::Hinge15Breaks(int num_cats, vector<double>& data, vector<bool>& undef) {
...
std::vector<double>  GenUtils::Hinge30Breaks(int num_cats, vector<double>& data, vector<bool>& undef) {
...
std::vector<double>  GenUtils::PercentileBreaks(int num_cats, vector<double>& data, vector<bool>& undef) {
...
std::vector<double>  GenUtils::StddevBreaks(int num_cats, vector<double>& data, vector<bool>& undef) {
